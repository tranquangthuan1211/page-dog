...
function App() {
  ...
  const allDogs = [
    ...
    },
    {
      ...
      price: "2500",
      description:
        "A dangerous breed but everyone loves cause they look cool",
      imageUrl:
  ...
  return (
    <CartContext.Provider value={{ total, setTotal, myCart, addMyCart }}>
      <Router>
        <Nav />
        <Routes>
          <Route path="/" element={<Home />} />
          <Route path="/dog" element={<Dog allDogs={allDogs} />}
          />
